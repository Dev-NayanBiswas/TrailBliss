    ...
    <>
        <section className="w-full">
          ...
          <section className="text-center mt-10">
            <h1 className="md:text-3xl lg:text-5xl lg:w-5/12 md:w-7/12 w-full mx-auto text-[30px] text-gray-800/65 font-bold">Discover Eco-Adventure <span className="md:text-3xl lg:text-5xl text-[30px] font-semibold text-[var(--primary-color)]">Bliss</span></h1>
